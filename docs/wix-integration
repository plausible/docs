...
* In your site's dashboard, click on "**Settings**", and in "**Tracking Tools**" click on "**Mange**".

* Click on the "**+ New Tool**" button and select "**Custom**".

* Paste your Plausible tracking code, choose which pages to add the code too ("**All Pages**"), click to select to "**Load code once**" ([read more about this here](https://support.wix.com/en/article/custom-code-loading-options)), select "**Head**" as the place for the code and click on the "**Apply**" button.
