...
## Reports, notifications and sharing

### Enable email and Slack reports and notifications for traffic spikes
...
You can share your Plausible stats with (potential) partners or advertisers. Or if you're working for an agency or working as a freelancer, you can share the site stats with your clients by generating a shared private link. The shared link is secure and impossible to guess by default. You can even password protect it. You can also limit a shared link to a specific audience segment so viewers only see the data that's relevant to them. [Learn more here](shared-links.md).
...
## Collaboration and multi-site management
...
If you manage multiple websites, the consolidated view gives you an overview of traffic across all of them in a single dashboard. It requires no configuration and automatically updates as you add or remove sites. [Learn more here](consolidated-views.md).
