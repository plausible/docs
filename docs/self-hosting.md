...
:::note
This section is for self-hosting our analytics on your server and manging your infrastructure (installation, maintenance, upgrades, server capacity, uptime, backup and so on). This is different from Plausible Analytics Cloud where we manage everything for you for your ease and convenience.  
:::
