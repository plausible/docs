...
| `group_conversion_rate` | `float` | The percentage of visitors who completed the goal with the same dimension. | Requires `event:goal` filter or dimension being set. |
