module.exports = {
  someSidebar: {
    ...
    "Website Settings": ['website-settings', 'general', 'users-roles', 'visibility', 'shared-links', 'embed-dashboard', 'google-search-console-integration', 'email-reports', 'traffic-spikes', 'slack-reports', 'excluding-pages', 'custom-locations', 'export-stats', 'transfer-ownership', 'reset-site-data', 'delete-site-data', 'excluding'],
