module.exports = {
  someSidebar: {
    ...
    "Goals and Custom Events": ['goal-conversions', 'outbound-link-click-tracking', 'file-downloads-tracking', 'error-pages-tracking-404', 'pageview-goals', 'custom-pageview-props', 'custom-event-goals',
      {
        type: 'category',
