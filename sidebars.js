module.exports = {
  someSidebar: {
    ...
    "Dashboard": ['guided-tour', 'top-referrers', 'manual-link-tagging', 'top-pages', 'countries', 'devices', 'filters-segments', 'metrics-definitions', 'keyboard-shortcuts', 'dashboard-faq'],
