module.exports = {
  someSidebar: {
    ...
    "Website Settings": ['landing-page', 'website-settings', 'general', 'timeformat', 'users-roles', 'visibility', 'shared-links', 'embed-dashboard', 'email-reports', 'traffic-spikes', 'slack-reports', 'excluding-pages', 'transfer-ownership', 'reset-site-data', 'delete-site-data', 'change-domain-name', 'excluding'],
